...
$config = [
   ...
   * reverse proxy).
   */
//  'baseurlpath' => 'http://ngeo.local.ge.ch:8099/noms-geographiques/saml',
  'baseurlpath' => 'http://cmsadmin-noms-geographiques.local.ge.ch:8099/saml',
  ...
  'technicalcontact_email' => 'kevin.notari@etat.ge.ch',
  ...
  */
   ...
   */
  'session.duration' => 12 * (60 * 60), // 12 hours.
   ...
   *
   */
  //TODO: Changed from 'localhost' to 'memcached'
  'memcache_store.servers' => [
    [
      ['hostname' => 'memcached'],
    ],
 ...
 */
   ...
   */
  'metadatadir' => '/var/www/html/config/saml/local',
...
//  'store.type'                    => 'sql',
   ...
   * syntaxes.
   */
//  'store.sql.dsn'                 => 'mysql:host=***REMOVED***;***REMOVED***;dbname=***REMOVED***',

  /*
   * The username and password to use when connecting to the database.
   */
//  'store.sql.username' => '***REMOVED***',
//  'store.sql.password' => '***REMOVED***',
